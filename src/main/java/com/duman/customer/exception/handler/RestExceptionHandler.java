package com.duman.customer.exception.handler;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<String> customHandleGenericException(GenericException ex) {
        String userMessage = messageSource.getMessage(ex.getErrorCode().name(), ex.getVar1().clone(), LocaleContextHolder.getLocale());
